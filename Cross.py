...
metrics_rede_neural = cross_validate(rede_neural, X_treino, y_treino, cv=5, scoring=['precision', 'recall', 'f1'])
...
metrics_random_forest = cross_validate(random_forest, X_treino, y_treino, cv=5, scoring=['precision', 'recall', 'f1'])
...
metrics_arvore_decisao = cross_validate(arvore_carregada, X_treino, y_treino, cv=5, scoring=['precision', 'recall', 'f1'])
